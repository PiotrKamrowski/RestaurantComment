...
<p><% if(place.getWww()==null){
    out.print("nie podano");}else{
    out.print(place.getWww());
    }
...
<button onclick="window.location.href='/secured/AddReview.jsp'">Dodaj receznje</button> <br/>
